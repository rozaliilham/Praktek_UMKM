...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- <div class="col-md-12 text-center">
            <h1 class="h4 mb-2 text-gray-800">Balas Tiket</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-envelope fa-fw"></i> Balas Tiket : <?= $judul['subjek'] ?>
                        <a href="<?= base_url('dashboard/daftar_tiket') ?>" type="button" class="small btn btn-danger btn-rd5 float-right">Kembali</a></h6>
                </div>
                <div class="card-body">
