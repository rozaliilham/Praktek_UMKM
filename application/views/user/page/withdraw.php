                ...
                <div class="card-body">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('dashboard/withdraw') ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="font-weight:bold" type="number" name="jumlah" class="form-control" value="">
                                    </div>
                                    <small class="text-success">Minimal withdraw: Rp 10.000</small>
                                </div>
